...
```{r comparing logit models, echo=TRUE}
...
confusionMatrix(test.results$logistic.modelpayments.prediction, test.results$default.payment.next.month)['Accuracy']
confusionMatrix(test.results$logistic.modeldemographics.prediction, test.results$default.payment.next.month)['Accuracy']
...
credit_target_category <- train_scaled$default.payment.next.month
credit_test_category <- test_scaled$default.payment.next.month
