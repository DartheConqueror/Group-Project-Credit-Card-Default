...
demo <- select(creditDf, c(sex, education, marriage, age, limit_bal, default.payment.next.month))

#all 'useful' payment variables
payment <- select(creditDf, c(bill_avg, pay_avg, bill_pay_ratio, avg_credit_usage, default.payment.next.month))
